    ...
    extend: {
      ...
      colors: {
        ...
        brand: {
          ...
          light: '#8FD6F5',          // Light Sky — subtext on dark, nav links on dark
          pale: '#E0F4FC',           // Pale Blue — cards, soft surfaces
          canvas: '#F0FAFF',         // Off White — page background
        },
        dark: {
          bg: '#101820',             // Dark Steel — hero, navbar, dark sections
          card: '#0D1B2A',           // Slightly lighter navy — inner cards on dark
          accent: '#29A8E0',         // Sky Blue
          midnight: '#060D14',       // Footer Midnight — only used in footer
        },
        chart: {
          '1': 'hsl(var(--chart-1))',
          '2': 'hsl(var(--chart-2))',
